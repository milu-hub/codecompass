...
/**
 * F6 快照构建：只含脱敏信息（无源码、无他人问答、成就只留 code+name）。
 */
class ShareServiceTest {
    ...
    void setUp() {
        ...
        service = new ShareService(qaHistoryRepository, learningPathRepository,
    ...
    @Test
    @DisplayName("快照含图/路线/自己的问答/已解锁成就，无源码与 clientId")
